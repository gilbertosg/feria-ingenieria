...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="{{ url('categorias') }}" class="logo">Ene-Mayo 2017</a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="li-criterios">
                        <a href="{{ url('criterios') }}">
                            <i class="fa fa-tags"></i> <span>Criterios de Evaluación</span>
                        </a>
                    </li>

                    <li id="li-evaluaciones">
                        <a href="{{ url('evaluaciones') }}">
                            <i class="fa fa-check"></i> <span>Evaluar</span>
                        </a>
                    </li>

                    <li id="li-premiaciones">
                        <a href="{{ url('premiaciones') }}">
                            <i class="fa fa-trophy"></i> <span>Premiaciones</span>
                        </a>
                    </li>
